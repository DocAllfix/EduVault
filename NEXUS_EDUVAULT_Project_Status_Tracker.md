...
**Ultimo aggiornamento:** 2026-05-23 (**FASE 2 COMPLETA ✅** — 2.6 endpoint /api/regulations (upload admin+rate 3/min, list/chunks paginati, delete soft→ABROGATA). ingest_regulation_file orchestra Stage 1-4. 100 test green (+8 route); mypy/ruff verdi (43 file); codegraph reindex (REI-15 trigger b fine fase). Pronto per commit FASE 2 (branch feat/phase2-kb-rag, tag v0.3.0-phase2). **BLOCCANTE residuo:** PDF DM 388 reale ancora mancante — ingestion testata solo su fixture sintetica + mock, MAI contro DB live o PDF gazzettiero reale; serve verifica E2E prima di FASE 3)  
